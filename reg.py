...
class Ui_reg_window(object):
    def setupUi(self, reg_window):
        reg_window.setObjectName("MainWindow")
        reg_window.resize(1000, 600)
...
"border-radius:20px;")
        ...
        self.label_3.setGeometry(QtCore.QRect(432, 130, 131, 60))
...
"")
        ...
        self.menubar = QtWidgets.QMenuBar(reg_window)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1000, 26))
        self.menubar.setObjectName("menubar")
        reg_window.setMenuBar(self.menubar)
